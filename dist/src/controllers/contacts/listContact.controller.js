...
const listContact_services_1 = __importDefault(require("../../services/contacts/listContact.services"));
const listContactController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const listedContacts = yield (0, listContact_services_1.default)();
